...
class AssetBackfillData(NamedTuple):
    ...
    def get_target_root_asset_partitions(
        ...
        while (
            ...
            unreachable_target_root_subset = unreachable_targets.filter_asset_keys(
                KeysAssetSelection(selected_keys=unreachable_targets.asset_keys)
                .sources()
    ...
    def get_target_root_partitions_subset(
        ...
        root_partitioned_asset_keys = (
            KeysAssetSelection(selected_keys=target_partitioned_asset_keys)
            .sources()
            .resolve(asset_graph)
        )
    ...
    def from_asset_partitions(
        ...
        if all_partitions:
            ...
            root_partitioned_asset_keys = (
                KeysAssetSelection(selected_keys=partitioned_asset_keys)
                .sources()
                .resolve(asset_graph)
            )
